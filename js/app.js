(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper-what")) new swiper_core_Swiper(".swiper-what", {
            ...
            navigation: {
                prevEl: ".what__arrow_1",
                nextEl: ".what__arrow_2"
            },
            on: {}
        });
    }
    ...
    document.querySelectorAll(".icon-menu");
    document.addEventListener("click", script_menuOpen);
    function script_menuOpen(ev) {
        const evElement = ev.target;
        if (evElement.closest(".icon-menu")) documEl.classList.toggle("menu-open");
    }
    ...
    headerConteiner.clientHeight;
    function myFunction() {
        if (window.scrollY) headerConteiner.classList.add("scrollM"); else headerConteiner.classList.remove("scrollM");
    }
    document.addEventListener("scroll", myFunction);
    console.log(headerConteiner);
